...
import { Kind, OperationTypeNode, parse, parseValue, print, visit } from '../../src';
import type {
  ASTNode,
...
export const graphqlPrint: typeof graphql.print = print;
export const webPrint: typeof print = graphql.print;
export const graphqlVisit: typeof graphql.visit = visit;
